  ...
  return (
    ...
    <div>
      ...
      <div className="table-container">
        <div className="table-header2">Candidate Name: {name}</div><br />
        ...
        <div className="footer">
          ...
          <Button className="tablebtn" tag={Link} to={"/manager/candidate"}>Go back</Button>
        </div>
        <div className="footer">
          <Button className="tablebtn" onClick={select} >Select for interview</Button>
